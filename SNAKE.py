...
def contact():
	...
	os.system('xdg-open https://www.facebook.com/mishan.xettri444')
...
\033[1;32m----------------------------------------------
➤➤⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃ BIPIN ⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃➤➤
❣︎[𖣘]☔︎CREATED BY   :  BIPIN_DON
❣︎[𖣘]☔︎ FB NAME     : BIPIN DON
❣︎[𖣘]☔︎ON GITHUB    :  BIPIN DON
❣︎[𖣘]☔︎TOOL STATUS  :  FREE
❣︎[𖣘]☔︎TOOL VERSION :  9.0                       
➤➤⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃ BIPIN DON⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃➤➤       
BIPIN DON  IT'S NOT A NAME. IT'S A BRAND
--------------------------------------------------
\033[1;37m------""")
def banner():
	print(logo)
...
def crack(idf,pwv):
	...
	sys.stdout.write(f"\r {P}[MISHAN]{P} {P}{loop}{P}/{P}{len(id)}{P} OK{P}[{H}{ok}{P}] [{P}{'{:.0%}'.format(loop/float(len(id)))}{P}]  "),
